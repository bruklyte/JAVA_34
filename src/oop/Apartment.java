...
public class Apartment {
    ...
    //kol reiksmes skiriasi, tol JAVA skaito,kad tai skirtingi konstruktoriai
    public Apartment(){
    ...
    public void printApartmentInfo(){
        ...
        System.out.println("Steet name: " + streetName);
        if(bath){
            System.out.println("This apartment has a bath");
        }else {
            System.out.println("This apartment has a NO bath");
        }
    }
}
